...
namespace Acg
{
	...
	Model* loadModelFromOBJ(std::string path)
	{
		...
		for (const auto& m : materials)
		{
			...
			if (m.emissive_texname != "")
			{
				...
				material.m_emission_texture = CreateRef<Texture>(p);
			}
	...
	///////////////////////////////////////////////////////////////////////
	void render(const Model* model, const Ref<Shader>& current_program, const bool submitMaterials)
	{
