...
#define HZ_MOUSE_BUTTON_LAST     HZ_FW_MOUSE_BUTTON_8
#define HZ_MOUSE_BUTTON_LEFT     HZ_FW_MOUSE_BUTTON_1
#define HZ_MOUSE_BUTTON_RIGHT    HZ_FW_MOUSE_BUTTON_2
#define HZ_MOUSE_BUTTON_MIDDLE   HZ_FW_MOUSE_BUTTON_3