...
namespace Mint {
    ...
    public:
        ...
        {
            MT_ASSERT(inLayer < Layers::NUM_LAYERS);
    ...
    inline JPH::Vec3 toVec3(const glm::vec3& v) { return { v.x, v.y, v.z }; }
    inline glm::vec3 toVec3(JPH::Vec3 v) { return { v.GetX(), v.GetY(), v.GetZ() }; }

    inline JPH::Vec4 toVec4(const glm::vec4 v) { return { v.x, v.y, v.z, v.w }; }
    inline const glm::vec4 toVec4(JPH::Vec4 v) { return { v.GetX(), v.GetY(), v.GetZ(), v.GetW() }; }
